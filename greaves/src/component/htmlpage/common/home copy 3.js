  ...
  return (
    <div>       
      ...
      <div className="row" style={{
        display: 'flex',          // Use flexbox on the row to align the column
        justifyContent: 'center', // Center columns horizontally
        // alignItems: 'center',     // Center columns vertically
        height: '10vh',          // Make the row take the full viewport height (optional)
       }}>
        <div className="col-lg-2 col-md-2 col-sm-2 mb-2" style={{
          display: 'flex',
          justifyContent: 'center', 
          alignItems: 'center', // Center the DatePicker within the column
          marginBottom: '20px'
        }}>
          <DatePicker
            selected={startDate}
          ...
          >
            Monthly production from Testing
              ...
              <button 
                ...
                onClick={() => exportToExcel(data_test, 'testing_data.xlsx')}
              >
                Download Data
              </button>
            </div>
          ...
          <div style={{ textAlign: 'center', position: 'relative', display: 'flex', justifyContent:'center' }}>
            ...
            >
              ...
              <button 
                ...
                onClick={() => exportToExcel(data_csr, 'csr_data.xlsx')}
              >
                Download Data
              </button>
            </div>
